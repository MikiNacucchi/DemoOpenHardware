...
public class UsbController {
	...
	private byte[] mData; //change to byte mData
	...
	private class UsbRunnable implements Runnable {
		...
		public void run() {//here the main USB functionality is implemented
			...
			L.d((mDevice == null ? "null": "no null"));
			
			UsbDeviceConnection conn = mUsbManager.openDevice(mDevice);
			
			L.d((conn == null ? "conn null": "conn no null"));
			L.d(("count = " + mDevice.getInterfaceCount()));
			L.d(("1 = " + (mDevice.getInterface(1)== null ? "null": "no null")));
			...
			for (;;) {// this is the main loop for transferring
				...
				conn.bulkTransfer(epOUT, mData, 4, 0);
